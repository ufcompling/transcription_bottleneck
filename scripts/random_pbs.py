...
for size in train_sizes:
	size = str(size)
	with open('pbs/' + size + '_random.pbs', 'w') as f:
		...
		for seed in ['1', '2', '3']:
			f.write('python scripts/train_random_w2v.py --lang ' + lg + ' --size ' + size + ' --seed ' + seed + ' --pretrained_model ' + pretrained_model + '\n')
			f.write('\n')
			f.write('python scripts/eval_random_w2v.py --lang ' + lg + ' --size ' + size + ' --seed ' + seed + ' --pretrained_model ' + pretrained_model + '\n')
			f.write('\n')
